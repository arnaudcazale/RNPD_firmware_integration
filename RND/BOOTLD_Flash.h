 ...
 * 1.0
 *******************************************************************************/
#ifndef __BOOTLD_FLASH_H__
#define __BOOTLD_FLASH_H__
...
/* Flash regions definition for the NUCLEO-F429ZI board */
 ...
 * Exported
 *******************************************************************************/
t_return 	BOOTLD_Flash_Init			(void);
t_return	BOOTLD_Flash_DeInit			(void);
t_return	BOOTLD_Flash_Erase_Sector	(uint32_t address);
t_return	BOOTLD_Flash_Write			(uint8_t *src, uint8_t *dest, uint32_t Len);
uint8_t*	BOOTLD_Flash_Read			(uint8_t *src, uint8_t *dest, uint32_t Len);
